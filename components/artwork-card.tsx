...
export function ArtworkCard({ artwork, isActive, dragOffset, index, currentIndex }: ArtworkCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Glassmorphism frame */}
        <div className="absolute inset-0 rounded-2xl border border-[#d4a5a5]/30 bg-[#faf3ed]/20 backdrop-blur-sm" />
        ...
        <div className="relative h-[400px] w-[400px] overflow-hidden rounded-2xl p-3 md:h-[500px] md:w-[500px]">
          ...
          <motion.div
            className="absolute inset-x-3 bottom-3 rounded-b-xl bg-gradient-to-t from-[#3d2c29]/80 via-[#3d2c29]/40 to-transparent"
          ...
          >
            <motion.p
              className="mb-1 font-mono text-xs uppercase tracking-widest text-[#f5ebe0]/70"
            ...
            <motion.h2
              className="font-serif text-2xl font-bold text-[#f5ebe0] md:text-3xl"
              animate={{ y: isHovered ? -5 : 0 }}
            ...
            <motion.p
              className="mt-2 text-sm text-[#f5ebe0]/80"
      ...
      <motion.div
        ...
        style={{
          background: `linear-gradient(to bottom, rgba(212, 165, 165, 0.2), transparent)`,
          transform: "scaleY(-1)",
        }}
